...
object CurriesPAF extends App {
  ...
  val insertName = concatenator("Hello, I'm ", _: String, " how are you?") // x: String => concatenator(hello, x, hay)
  println(insertName("Petar"))

  val fillInTheBlanks = concatenator("Hello, ", _: String, _: String) //x, y => concatenator(hello, x, y)
  println(fillInTheBlanks("Petar", "Scala is awesome!"))
